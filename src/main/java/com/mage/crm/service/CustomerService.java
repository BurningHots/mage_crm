...
public class CustomerService {
    ...
    public void delete(Integer[] id) {
        AssertUtil.isTrue(customerDao.delete(id)<1,"客户信息删除失败");
    }
    ...
    public Map<String, Object> queryCustomersContribution(CustomerGCQuery customerGCQuery) {
        ...
        PageInfo<CustomerDto> customerDtoPageInfo = new PageInfo<>(list);
        Map<String, Object> map = new HashMap<>();
    ...
    public Map<String, Object> queryCustomerGC() {
        List<CustomerDto> list = customerDao.queryCustomerGC();
        // 准备x坐标和y坐标
        String[] levels = null;
        Integer[]  counts = null;
        Map<String, Object> map = new HashMap<>();
