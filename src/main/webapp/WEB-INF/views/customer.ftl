...
<div id="tb">
    <div>
        ...
        <a href="javascript:openCustomerOtherInfo('交往记录管理',2)"
           class="easyui-linkbutton" iconCls="icon-jwjl" plain="true">交往记录管理</a>
        <a href="javascript:openCustomerOtherInfo('历史订单查看',3)"
           class="easyui-linkbutton" iconCls="icon-jwjl" plain="true">历史订单查看</a>
    </div>
    <div>
        ...
        <table cellspacing="8px">
            ...
            <tr>
                ...
                <td colspan="4"><input type="text" id="address" name="address"
                                       style="width: 400px" class="easyui-validatebox" required="true"/>&nbsp;
                    <font color="red">*</font></td>
            </tr>
            <tr>
                <td>营业执照注册号：</td>
