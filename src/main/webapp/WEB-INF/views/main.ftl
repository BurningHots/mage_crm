    ...
    <div class="easyui-accordion" data-options="fit:true,border:false">
        ...
        <#if userPermission?seq_contains('40')>
            <div title="统计报表" data-options="iconCls:'icon-tjbb'" style="padding:10px">
                ...
                <#if userPermission?seq_contains('4020')>
                ...
                <#if userPermission?seq_contains('4030')>
                ...
                <#if userPermission?seq_contains('4040')>
        ...
        <#if userPermission?seq_contains('50')>
            <div title="基础数据管理" data-options="iconCls:'icon-jcsjgl'" style="padding:10px">
                <#if userPermission?seq_contains('5010')>
                ...
                <#if userPermission?seq_contains('5020')>
        ...
        <#if userPermission?seq_contains('60')>
            <div title="系统管理" data-options="iconCls:'icon-item'" style="padding:10px">
                ...
                <#if userPermission?seq_contains('6040')>
                ...
                <#if userPermission?seq_contains('6050')>
